...
def Track():
    ...
    #country
    loacate = geocoder.description_for_number(number, 'en')
    country.config(text=locate)

    #operator like idea, airtel, safaricom
    ...
    geolocator = Nominator(user_agent =  "geoapiExercises")
...
#search button
Search_image = photo(file="search.png")
